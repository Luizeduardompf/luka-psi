...
- Profile: removed preferred_name, added birth_date (DD/MM/YYYY mask + validation), NIF/CPF validation wired
...
- forms/send.tsx: senha not stored in compiled custom_message snapshot
- Public form (f/[token].tsx): required field validation, date validation, inline errors, fixed submit
